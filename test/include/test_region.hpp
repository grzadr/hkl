...
class InputRegionArgs {
 ...
 public:
  ...
  InputRegionArgs(string chrom, string first, string last, string strand) {
    if (chrom != "None") this->chrom = chrom;
    if (strand != "None") this->strand = strand;
